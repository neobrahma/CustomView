...
class SwitchDoubleCanalView : AbstractSwitchView {
    ...
    var direction: Position = Position.LEFT
    ...
    private fun drawBackground(canvas: Canvas) {
        ...
        canvas.drawArc(rectShape, 90f, 180f * direction.value, true, paint)
    }
    ...
    override fun isTouchInShape(touchPoint: PointF): Boolean {
        return computeDistanceSegment(touchPoint, centerPoint) <= rayon
                && minX <= touchPoint.x && touchPoint.x <= maxX
    }
}